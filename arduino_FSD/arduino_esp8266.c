...
void loop() 
{
  ...
  {
    ulReqcount++;
 sResponse  = "<html><head><title>FSBulgaria-Pijo</title><meta charset=\"utf-8\"></head><body>";
    sResponse += "<font color=\"#000000\"><body>";
    sResponse += "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, user-scalable=yes\">";
    sResponse += "<center><a href=\"http://formulastudentbg.com/bg\"><img src=\"http://formulastudentbg.com/wp-content/themes/zerif-lite/images/logo.png\" alt=\"FStudent-Bulgaria\"></a><h1>WiFi control:</h1>";
